        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden mb-8">
            ...
            <div className="h-44 md:h-56 w-full bg-gradient-to-r from-orange-500 via-orange-600 to-amber-600 relative group">
                ...
                <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button className="px-3 py-1.5 bg-black/20 hover:bg-black/40 backdrop-blur-md text-white text-xs font-bold rounded-lg transition-all flex items-center gap-2 border border-white/10">
            ...
            <div className="px-8 relative">
                ...
                <div className="flex justify-between items-end -mt-16 mb-5">
                    {/* Avatar */}
                    <div className="relative group p-1 bg-white dark:bg-slate-900 rounded-2xl">
                        <div className="w-32 h-32 rounded-xl overflow-hidden relative z-10 bg-slate-100 dark:bg-slate-800">
                            <img 
                        ...
                        <button className="absolute bottom-2 right-2 z-20 p-2 bg-slate-900 text-white rounded-full hover:bg-orange-600 transition-colors shadow-lg border border-white dark:border-slate-800 opacity-0 group-hover:opacity-100">
                           <Camera size={14} />
                        </button>
                    </div>
                    ...
                    <div className="flex items-center gap-3 mb-2">
                         <button className="px-4 py-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 rounded-lg text-xs font-bold uppercase tracking-wider transition-all shadow-sm flex items-center gap-2">
                            <Share2 size={14} /> <span className="hidden sm:inline">Share</span>
                         </button>
                         <button className="px-4 py-2 bg-orange-600 hover:bg-orange-700 text-white rounded-lg text-xs font-bold uppercase tracking-wider shadow-lg shadow-orange-500/20 transition-all flex items-center gap-2">
                ...
                <div className="mb-8">
                    <div className="flex items-center gap-3 mb-1">
                        <h1 className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">John Cena</h1>
                        <span className="px-2 py-0.5 rounded-md bg-blue-50 dark:bg-blue-500/10 text-blue-600 dark:text-blue-400 text-[10px] font-bold uppercase tracking-wide border border-blue-100 dark:border-blue-500/20 flex items-center gap-1.5">
                            <CheckCircle2 size={12} fill="currentColor" className="text-blue-600 dark:text-blue-400" /> Verified
                        </span>
                    </div>
                    
                    <p className="text-slate-500 dark:text-slate-400 font-medium text-base mb-4 flex items-center gap-2">
                    ...
                    {/* Meta Data */}
                    <div className="flex flex-wrap items-center gap-6 text-xs font-medium text-slate-500 dark:text-slate-400">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            {activeTab === 'details' ? (
              <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-8 shadow-sm">
                <div className="flex items-center justify-between mb-8">
                   ...
                   <button className="px-4 py-2 bg-slate-900 dark:bg-white dark:text-slate-900 text-white rounded-lg text-xs font-bold flex items-center gap-2 hover:opacity-90 transition-all">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input 
                        ...
                        className="w-full pl-10 pr-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-sm font-medium outline-none focus:border-orange-500 transition-all dark:text-white"
                      />
                    </div>
                  </div>
                ...
                <div className="mt-6 space-y-2">
                  ...
                  <textarea 
                    ...
                    className="w-full p-4 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-sm font-medium outline-none focus:border-orange-500 transition-all dark:text-white resize-none"
                  />
                </div>
              </div>
            ) : (
              <div className="space-y-6">
                <div className="bg-gradient-to-br from-slate-900 to-slate-800 text-white rounded-xl p-8 shadow-xl relative overflow-hidden border border-slate-700">
                ...
                <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-8 shadow-sm">
                  ...
                  <div className="space-y-4">
                    ...
                    <button className="w-full py-3 border-2 border-dashed border-slate-200 dark:border-slate-700 rounded-lg text-xs font-bold uppercase tracking-widest text-slate-500 hover:text-orange-600 hover:border-orange-500/30 transition-all">
                      + Add Payment Method
                    </button>
                  </div>
                </div>
          ...
          <div className="space-y-6">
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-6 shadow-sm">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 font-medium mb-6">Your profile is 85% complete. Add your social links to reach 100%.</p>
            ...
            <div className="bg-orange-50 dark:bg-orange-900/10 border border-orange-100 dark:border-orange-900/30 rounded-xl p-6">
              ...
              <button className="w-full py-2 bg-orange-600 text-white text-xs font-bold rounded-lg shadow-lg shadow-orange-600/20 hover:bg-orange-700 transition-all">
                View Team Plans
              </button>
            </div>
          </div>
