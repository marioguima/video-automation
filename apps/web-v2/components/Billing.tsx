    ...
    <div className="h-full overflow-y-auto custom-scrollbar bg-slate-50 dark:bg-slate-950">
      <div className="max-w-6xl mx-auto p-6 md:p-10 pb-24">
        ...
        <div className="mb-10">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Manage your subscription, payment methods, and download invoices.</p>
        </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-8 shadow-sm relative overflow-hidden">
              ...
              <div className="flex flex-col md:flex-row md:items-start justify-between gap-6 relative z-10 mb-8">
                <div>
                  ...
                  <h2 className="text-4xl font-bold text-slate-900 dark:text-white mb-2">Pro Creator</h2>
                ...
                <div className="text-right">
                  <h3 className="text-3xl font-bold text-slate-900 dark:text-white">$29<span className="text-base text-slate-400 font-medium">/mo</span></h3>
                </div>
              </div>

              {/* Usage Stats */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 bg-slate-50 dark:bg-slate-950/50 p-6 rounded-xl border border-slate-100 dark:border-slate-800">
                <div className="space-y-2">
                  <div className="flex justify-between text-xs font-bold uppercase tracking-wide text-slate-500">
                    <span>Video Minutes</span>
                    <span className="text-slate-900 dark:text-white">82% Used</span>
                  </div>
              ...
              <div className="flex gap-4">
                 <button className="px-6 py-3 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-lg text-xs font-bold uppercase tracking-wider hover:bg-slate-800 dark:hover:bg-slate-200 transition-all">
                    Change Plan
                 </button>
                 <button className="px-6 py-3 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 rounded-lg text-xs font-bold uppercase tracking-wider hover:bg-slate-50 dark:hover:bg-slate-700 transition-all">
                    Cancel Subscription
                 </button>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-sm overflow-hidden">
               <div className="p-6 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
                  ...
                  <button className="text-xs font-bold text-orange-600 hover:text-orange-700 uppercase tracking-wide">Download All</button>
               </div>
               <div className="overflow-x-auto">
                 <table className="w-full text-left">
                    <thead className="bg-slate-50 dark:bg-slate-950/50 text-[10px] font-bold uppercase tracking-widest text-slate-400">
                       <tr>
                       ...
                       {[
                         ...
                         <tr key={inv.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                            ...
                            <td className="px-6 py-4 text-right">
                               <button className="p-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-md text-slate-400 hover:text-orange-600 transition-all">
                                  <Download size={16} />
                               </button>
                            </td>
                         </tr>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-sm">
              <div className="flex items-center justify-between mb-6">
                ...
                <button className="text-xs font-bold text-orange-600 hover:text-orange-700 uppercase tracking-wide flex items-center gap-1">
                   <Plus size={14} /> Add New
                </button>
              </div>

              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800 rounded-xl border border-orange-200 dark:border-orange-500/30 relative overflow-hidden group">
                ...
                <div className="flex items-center justify-between p-4 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 opacity-60 hover:opacity-100 transition-opacity">
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-sm">
               <div className="flex items-center justify-between mb-6">
                <h3 className="text-lg font-bold text-slate-900 dark:text-white">Billing Address</h3>
                <button className="text-xs font-bold text-slate-400 hover:text-orange-600 uppercase tracking-wide">Edit</button>
              </div>
              <div className="text-sm text-slate-600 dark:text-slate-300 space-y-1">
                 <p className="font-bold text-slate-900 dark:text-white">John Cena</p>
              ...
              <div className="mt-6 pt-6 border-t border-slate-100 dark:border-slate-800">
                 <div className="flex items-center gap-3">
                    ...
                    <div>
                       <p className="text-xs font-bold text-slate-900 dark:text-white">Secure Payment Processing</p>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/10 border border-blue-100 dark:border-blue-800/30 rounded-2xl p-6">
               <div className="flex items-start gap-3">
                  ...
                  <div>
                     ...
                     <button className="text-xs font-bold text-blue-700 dark:text-blue-300 underline">Contact Support</button>
                  </div>
               </div>
            </div>
