...
Task: generate on_screen and image_prompt for block ${index} of ${total}.
...
export function normalizeBlockMetaResponse(
  ...
  const candidate = parsed as { on_screen?: unknown; image_prompt?: unknown };
  ...
  return { onScreen: candidate.on_screen, imagePrompt };
}
